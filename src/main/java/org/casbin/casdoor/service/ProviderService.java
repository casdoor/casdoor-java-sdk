...
public class ProviderService extends Service {
    ...
    public CasdoorResponse<String, Object> updateProvider(Provier provider) throws IOException {
        return modifyProvider(ProviderOperations.UPDATE_PROVIDER, provider, null);
    }

    public CasdoorResponse<String, Object> addProvider(Provier provider) throws IOException {
        return modifyProvider(ProviderOperations.ADD_PROVIDER, provider, null);
    }

    public CasdoorResponse<String, Object> deleteProvider(Provier provider) throws IOException {
        return modifyProvider(ProviderOperations.DELETE_PROVIDER, provider, null);
    }

    private <T1, T2> CasdoorResponse<T1, T2> modifyProvider(ProviderOperations method, Provier provider, java.util.Map<String, String> queryMap) throws IOException {
