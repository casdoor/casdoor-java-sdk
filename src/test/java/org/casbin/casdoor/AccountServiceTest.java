...
public class AccountServiceTest {
    ...
    public void setUp() {
        /* Given */
        subject = new AccountService(ConfigFactory.getConfig());
    }
    ...
    public void getAccount() throws IOException {
        /* When */
        CasdoorResponse<User, Organization> response = subject.getAccount("eyJhbGciOiJSUzI1NiIsImtpZCI6ImNlcnQtYnVpbHQtaW4iLCJ0eXAiOiJKV1QifQ." +
